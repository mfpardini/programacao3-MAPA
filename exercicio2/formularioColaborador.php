...
<html lang="pt-br">
  ...
  <body class="body">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background-color: #e3f2fd;">
  	...
  	<div class="container">
	    <h1 class="p-2 text-center">Cadastro de Colaborador</h1>
	    <h3 class="p-1 text-center">Entre com os dados do colaborador:</h3>
		<form action="controllerColaborador.php" method="post">
		  	<div class="form-group">
	    		<div class="form-group d-flex row p-1">
		    	...
		    	<div class="form-group d-flex row p-1">
		    		<label class="col-sm-3 text-md-right">Setor:</label>
		    		<input class="form-control col-sm-6" type="text" name="setor" placeholder="Setor">
		    	</div>
		    	<div class="form-group d-flex row p-1">
		    		<label class="col-sm-3 text-md-right">Data de adimissão:</label>
		    		<input class="form-control col-sm-6" type="text" name="dataAdmissao" placeholder="dd/mm/aaaa">
		    	</div>
		    	<div class="form-group d-flex row p-1">
		    		<label class="col-sm-3 text-md-right">Salário:</label>
		    		<input class="form-control col-sm-6" type="text" name="salario" placeholder="Salário">
		    	</div>
		  	</div>
		  	<div class="col text-center">
		  		<button style="width: 300px" type="submit" class="btn btn-primary">Enviar formulário</button>
		  	</div>
		</form>
	</div>
